              ...
              <div key={result.id} className="group flex flex-col gap-3 pb-8 border-b border-slate-100 last:border-0 hover:opacity-90 transition-opacity">
                ...
                <div className="flex gap-4 mt-2">
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-1.5 px-4 py-2 text-[11px] font-bold text-emerald-700 bg-emerald-50 hover:bg-emerald-600 hover:text-white border border-emerald-100 hover:border-emerald-600 rounded-md transition-all shadow-sm group-hover:shadow"
                    >
                        BUKA FILE PDF
                        <svg className="w-3.5 h-3.5 opacity-70" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
                    </a>
                </div>
              </div>
            ))}
